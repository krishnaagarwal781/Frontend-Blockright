...
export const Rightspage = () => {
  ...
  const handleSubmitPost = (e) => {
    ...
    const options = {
      ...
      data: {
        walletId: "6501f943165338942b3a141c",
        nftId: "6501f953165338942b3a1432",
            ...
            <div className="w-[35rem]">
              ...
              <Accordion className="mb-2">
                ...
                <AccordionDetails>
                  ...
                  <h2 className="font-bold texl-xl text-black mt-5">
                    $ {result1} earning from license royalty
                  </h2>
              ...
              <Accordion className="mb-2">
                ...
                <AccordionDetails>
                  ...
                  <h2 className="font-bold texl-xl text-black mt-5">
                    $ {result2} earning from license royalty
                  </h2>
                  <div className="flex mt-2">
                    <p className="">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
              ...
              <Accordion className="mb-2">
                ...
                <AccordionDetails>
                  ...
                  <h2 className="font-bold texl-xl text-black mt-5">
                    $ {result3} earning from license royalty
                  </h2>
                  <div className="flex mt-2">
                    <p className="">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
              ...
              <Accordion className="mb-2">
                ...
                <AccordionDetails>
                  ...
                  <h2 className="font-bold texl-xl text-black mt-5">
                    $ {result4} earning from license royalty
                  </h2>
                  <div className="flex mt-2">
                    <p className="">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
