                    ...
                    <div className='ml-36'>
                        {activeTab === 0 && (
                            <div className='mt-10  inline-block w-[37rem] text-slate-500 font-normal '>
                                <p className=" ">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium cupiditate qui sequi dolorem, consequatur earum corrupti! Labore qui facere sapiente. Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi tempora maxime quas, sit sapiente natus beatae molestias magni atque labore corporis optio reiciendis ipsa vitae aut quae! Exercitationem, eveniet in.
                                </p>
