      ...
      <div className="lg:mx-auto lg:w-[55rem]  2xl:w-[75rem] 2xl:mx-auto">
        ...
        <header className="body-font" id="Home">
          <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <button className="font-semibold mr-[2rem] lg:inline-flex items-center bg-blue-600 text-white border-2 border-blue-900 py-1 px-3 hover:bg-gray-200 rounded text-base mt-4 md:mt-0 hidden">
